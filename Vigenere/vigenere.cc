...
/**
 * Funcion que se usa para dividir
 * el mensaje original en funcion del
 * tamaño de la clave
**/
...
/**
 * Funcion que usa el algoritmo de
 * el cifrado de vigenere para encontrar el equivalente cifrado
 * entre las letras del mensaje y de la clave.
**/
...
/**
 * Funcion que se usa para descifrar el mensaje.
 * Es la operacion inversa al metodo MathCipherOp().
**/
...
/**
 * Funcion que se encarga de crifrar el mensaje
 * original con el metodo de Vigenere.
**/
...
/**
 * Funcion que se encarga de descrifrar el mensaje
 * cifrado por el metodo de Vigenere.
**/
...
/**
 * Funcion que se encarga de escribir por pantalla el mensaje
 * cifrado por el metodo de Vigenere.
**/
